...
class LogWrapper(GymnaxWrapper):
    ...
    def step(
        ...
        state = LogEnvState(
            ...
            episode_return=state.episode_return * (1 - done)
            + new_episode_return * done,
            episode_length=state.episode_length * (1 - done)
            + new_episode_length * done,
            timestep=state.timestep + 1,
        )
        info["episode_return"] = state.episode_return
        info["episode_length"] = state.episode_length
